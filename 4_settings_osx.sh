...
defaults write NSGlobalDomain ApplePressAndHoldEnabled -bool false && defaults write NSGlobalDomain KeyRepeat -int 1 && defaults write NSGlobalDomain InitialKeyRepeat -int 10
